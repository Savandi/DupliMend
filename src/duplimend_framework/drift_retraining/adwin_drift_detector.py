...
class ADWINDriftDetector:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        # Initialize ADWIN detectors for different metrics
        ...
        # Window statistics for analysis
    ...
    def update_embedding_metrics(self, activity_label: str, embeddings: np.ndarray, 
        ...
        # Update ADWIN for embedding norm
        ...
        # Update ADWIN for embedding variance
    ...
    def detect_combined_drift(self, activity_label: str, reconstruction_error: float,
        ...
        # Update embedding metrics if available
        ...
        # Update cluster metrics if available
    ...
    def reset_detector(self, activity_label: str, metric_type: Optional[str] = None):
        ...
        if metric_type:
            ...
            # Reset all metrics for this activity
    ...
    def save_drift_state(self, filepath: str):
        ...
        state = {
            ...
            'drift_history': {k: v[-100:] for k, v in self.drift_history.items()},  # Save last 100 events
