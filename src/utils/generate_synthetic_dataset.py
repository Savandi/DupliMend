...
log_v1.to_csv("../homonym_mend/synthetic_log_v1.csv", index=False)
log_v2.to_csv("../homonym_mend/synthetic_log_v2.csv", index=False)
log_v3.to_csv("../homonym_mend/synthetic_log_v3.csv", index=False)
