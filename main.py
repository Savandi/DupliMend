...
event_counter = 1
previous_event = None  # Initialize previous_event
...
for _, event in df_event_log.iterrows():
    try:
        ...
        # Integrate adaptive binning and discretization
        ...
        if previous_event:
            print(
                f"Control-Flow Debug: Previous Activity: {previous_event[control_flow_column]}, Current Activity: {processed_event[control_flow_column]}"
            )
